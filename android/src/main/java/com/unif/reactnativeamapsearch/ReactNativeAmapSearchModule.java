package com.unif.reactnativeamapsearch;
...
@ReactModule(name = ReactNativeAmapSearchModule.NAME)
public class ReactNativeAmapSearchModule extends ReactContextBaseJavaModule {
  public static final String NAME = "ReactNativeAmapSearch";
  ...
  public ReactNativeAmapSearchModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
  ...
  public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
    ...
    public void onPoiItemSearched(PoiItemV2 poiItem, int rCode) {
      ...
      if (rCode == AMapException.CODE_AMAP_SUCCESS) {
        this.jsPromise.resolve(formatDataPoiV2(poiItem));
      } else {
